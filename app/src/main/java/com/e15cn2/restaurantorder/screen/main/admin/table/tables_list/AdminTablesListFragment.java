...
public class AdminTablesListFragment extends BaseFragment<FragmentRecyclerViewBinding> {
    private static final String ARGUMENT_TABLES = "ARGUMENT_TABLES";
    private BaseAdapter<Table> mAdapter;
    private List<Table> mTables;

    public static AdminTablesListFragment newInstance(List<Table> tables) {
        AdminTablesListFragment fragment = new AdminTablesListFragment();
