...
import com.e15cn2.restaurantorder.screen.main.admin.table.tables_list.AdminTablesList;
...
public class AdminTableFragment extends BaseFragment<FragmentTableAdminBinding>
    ...
    public void onGetTablesSuccess(List<Table> tables) {
        ...
        mFragments.add(AdminTablesList.newInstance(tables4));
        mFragments.add(AdminTablesList.newInstance(tables6));
        //init viewpager
